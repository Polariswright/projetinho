                ...
                <div class="card-footer alert">
                    <form action="#" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" name="login" class="caixinha form-control" placeholder="Digite o seu e-mail" required>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <p class="mt-5"><a class="cadastro" href="../user/formUser.php">Não possuo cadastro</a></p>
                            </div>
                            <div class="col">
                                <p class="mt-5"><a class="cadastro" href="../user/editSenha.php">Esqueceu a senha?</a></p>
                            </div>
                        </div>
                    </form>
